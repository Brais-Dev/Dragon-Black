...
configBase = "[HOME] = ~"
configFile = "../dragon.conf"
cache_1 = prefix+"/tmp/dragon_black"
...
def termux_pro():
  ...
  os.system(' git clone https://github.com/DevCoreXOfficial/core-termux.git')
  os.system('mv core-termux {}'.format(homeDir))
  os.chdir('core-termux')
